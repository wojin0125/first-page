...
st.markdown("텍스트의 색상을 :green1[초록색]으로, 그리고 **:blue[파란색]** 볼트체로 설정할 수 있습니다.")
st.markdown(" :green[$/sprt{x^2+y^2}=1$] 와 같이 latex 문법의 수식 표현도 가능합니다 :pencil:")

#Latex 수식 지원
st.latex(r'/sprt{x^2+y^2}=1')
